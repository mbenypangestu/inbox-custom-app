export function generateField(field, isVisible = false, requireds) {
    ...
    const requiredBadge = requireds ? '<span class="sf-required-dot" title="Required">i</span>' : '';

    if (field.field_type === 'dropdown') {
        fieldHtml += `<div class="field-container sf-row ${visibilityClass}" data-level="${field.class_hierarchical_level}">`;
        fieldHtml += `<label for="${field.field_title}">${field.field_title}${requiredBadge}</label>`;
        fieldHtml += `<div class="sf-input-wrap">`;
        fieldHtml += `<select id="${field.field_title}" name="${field.field_title}" class="dynamic-dropdown sf-control" data-level="${field.class_hierarchical_level}" select-one>`;
        ...
        fieldHtml += `<label for="${field.field_title}">${field.field_title}${requiredBadge}</label>`;
        fieldHtml += `<div class="sf-input-wrap">`;
        fieldHtml += `<input class="sf-control" type="text" id="${field.field_title}" name="${field.field_title}" placeholder="${field.field_description || '-'}" />`;
        fieldHtml += `</div>`;
        fieldHtml += `</div>`;
        ...
        fieldHtml += `<label for="${field.field_title}">${field.field_title}${requiredBadge}</label>`;
        fieldHtml += `<div class="sf-input-wrap">`;
        fieldHtml += `<input class="sf-control" type="date" id="${field.field_title}" name="${field.field_title}" />`;
        fieldHtml += `</div>`;
        fieldHtml += `</div>`;
        ...
        fieldHtml += `<label for="${field.field_title}">${field.field_title}${requiredBadge}</label>`;
        fieldHtml += `<div class="sf-input-wrap">`;
        fieldHtml += `<input class="sf-control" type="number" id="${field.field_title}" name="${field.field_title}" placeholder="${field.field_title}" />`;
        fieldHtml += `</div>`;
        fieldHtml += `</div>`;
    }
